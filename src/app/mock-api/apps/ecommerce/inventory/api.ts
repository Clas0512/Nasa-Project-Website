...
import { brands as brandsData, categories as categoriesData, products, products as productsData, tags as tagsData, vendors as vendorsData } from 'app/mock-api/apps/ecommerce/inventory/data';
...
export class ECommerceInventoryMockApi
{
    ...
    registerHandlers(): void
    {
        // -----------------------------------------------------------------------------------------------------
            ...
            this,this._fuseMockApiService.onGet("api/products" ) .reply(() =>  [200, products])
